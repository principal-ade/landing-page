    ...
    >
        ...
        <div>
          ...
          {phase === 'incident-active' && (
            <>
              ...
              <GameBodyText
                text={GAME_CONTENT.incidentActive.text}
                opacity={0.9}
                marginBottom="0"
              />
            </>
          ...
          {phase === 'incident-resolved' && (
            <>
              ...
              <GameBodyText
                text={GAME_CONTENT.incidentResolved.text}
                opacity={0.9}
                marginBottom="0"
              />
            </>
        ...
        <div style={{ minHeight: '56px' }}>
          ...
          {phase === 'incident-resolved' && (
            ...
            >
              ...
              {mode === 'conventional' && onTryPrincipal && (
                <Button onClick={onTryPrincipal} variant="ghost">
      ...
      >
        <MazePanel
          ...
          isMobile={isMobile}
          showMaze={true}
          showCoverOverlay={(phase === 'cost-info' && showOverlay) || phase === 'deployed-running' || phase === 'incident-active'}
        />
      </div>
    </div>
  );
