...
interface PrincipalTestingScreenProps {
...
/**
 * Principal Testing Screen - shows testing with Principal AI telemetry
 * Emphasizes story-based telemetry and full visibility
 */
export function PrincipalTestingScreen({ phase, onBack, onTestLocally, onDeploy, gameState, agentUsage }: PrincipalTestingScreenProps) {
  ...
  const lineConfigs = useMemo(() => {
    const lines = GAME_CONTENT.testing.lines.principal;
      ...
      <div>
        ...
        {phase === 'testing' && (
          <>
            ...
            {/* Principal-specific info - Line 2 */}
            <GameBodyText
