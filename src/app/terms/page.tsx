    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#000000" }}>
      ...
      <main style={{ flex: 1, paddingTop: "100px", paddingBottom: "60px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            <div dangerouslySetInnerHTML={{ __html: content.replace(/\n/g, '<br/>').replace(/^# (.+)$/gm, '<h1 style="font-size: 48px; margin: 0 0 32px 0; color: #00C2FF;">$1</h1>').replace(/^## (.+)$/gm, '<h2 style="font-size: 32px; margin: 48px 0 24px 0; color: #ffffff;">$2</h2>').replace(/^### (.+)$/gm, '<h3 style="font-size: 24px; margin: 32px 0 16px 0; color: #ffffff;">$1</h3>').replace(/^\*\*(.+):\*\*/gm, '<strong style="color: #00C2FF;">$1:</strong>') }} />
          </div>
        </div>
      </main>
      <Footer />
