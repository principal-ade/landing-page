 ...
 * It features:
 * - Neural blue animated gradient background
 * - PrincipalAI branding with wireframe logo
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'The hero section is the first impression of the landing page. It features a neural blue gradient background, PrincipalAI branding with wireframe logo sphere, centered typography with Inter/Geist Sans font, and call-to-action buttons following the Principal AI design guidelines.',
      },
    },
  },
  decorators: [
 ...
 * Features the PrincipalAI branding, neural blue design, and core message.
 */
