      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <br />
            Six markers. Four views. Click through them.
          </p>
        </motion.div>

        {/* Demo Container - Browser Chrome */}
        <motion.div
        ...
        >
          ...
          >
            ...
            >
              ...
              app.principal-ade.com/trail/trail-electron-app-tour
            </div>
          </div>
        ...
        >
          ...
          >
            File City shows <strong style={{ color: theme.colors.primary }}>where</strong>.
            Sequence shows <strong style={{ color: theme.colors.primary }}>how</strong>.
            Code shows <strong style={{ color: theme.colors.primary }}>what</strong>.
            Description explains <strong style={{ color: theme.colors.primary }}>why</strong>.
          </p>
